  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600] h-[600] bg-secondary/10 rounded-full blur-[150px]" />
      </div>
          ...
          <div className="glass-strong neon-border rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-3">
                <div className="h-1 w-16 bg-linear-to-r from-primary to-accent rounded-full pulse-glow" />
